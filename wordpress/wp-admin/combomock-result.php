...
$sql = "(select QuestionId,Question,Option1,Option2,Option3,Option4,Answer,null as Solution from pmp 
where QuestionId IN  (" . implode(",", $samp) . "))
 UNION (select QuestionId,Question,Option1,Option2,Option3,Option4,Answer,null as Solution from 
 nfpa where QuestionId IN  (" . implode(",", $samp) . ")) UNION (select QuestionId,Question,
Option1,Option2,Option3,Option4,Answer,null as Solution from thermodynamics where QuestionId IN  
(" . implode(",", $samp) . ")) UNION (select QuestionId,Question,
Option1,Option2,Option3,Option4,Answer,null as Solution from refrigeration where QuestionId IN  
(" . implode(",", $samp) . ")) UNION (SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer,null 
as Solution FROM mock_test where QuestionId IN  
(" . implode(",", $samp) . ")) UNION (SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer,
Solution FROM fluid_problems where QuestionId IN  
(" . implode(",", $samp) . ")) UNION (SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer,
null as Solution FROM gas_dynamics where QuestionId IN  
(" . implode(",", $samp) . ")) ORDER BY FIELD(QuestionId, " . implode(",", $samp) . ")"; 
