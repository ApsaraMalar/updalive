<?php
session_start();
if(isset( $_SESSION['completedthermo'])){
		unset($_SESSION['completedthermo']);
    header("Location: https://www.updatraining.com/thermodynamics/");
    exit();
 }else{
?>
 <html>
...
<div class="container">
<h1><center>Thermodynamics Practice-3</h1>
</br></br>
 <?php
echo "<form action='https://www.updatraining.com/wp-admin/thermodynamics-mock-result.php' method='post'>";
$link = mysqli_connect("localhost", "nirupan_admin", "niru@2089", "nirupan_updamech");
if ($link === false) {
    die("ERROR: Could not connect. " . mysqli_connect_error());
}

$sql       = "(SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer FROM thermodynamics where
QuestionId BETWEEN 51 and 75)";
