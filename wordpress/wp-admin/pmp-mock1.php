<?php
session_start();
if(isset( $_SESSION['completedpmp'])){
		unset($_SESSION['completedpmp']);
    header("Location: https://www.updatraining.com/pmp/");
    exit();
 }else{
?>
 <html>
...
<div class="container">
<h1><center>PMP Practice</h1>
</br></br>
 <?php
echo "<form action='https://www.updatraining.com/wp-admin/pmp-mock-result.php' method='post'>";
$link = mysqli_connect("localhost", "nirupan_admin", "niru@2089", "nirupan_updamech");
if ($link === false) {
    die("ERROR: Could not connect. " . mysqli_connect_error());
}

$sql       = "(SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer FROM pmp where
QuestionId BETWEEN 6001 and 6025)";
