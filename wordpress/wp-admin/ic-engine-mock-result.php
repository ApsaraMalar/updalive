<?php
session_start();
$_SESSION['completedic'] = "yes";
echo "<html>
<style>
body {background-color:  #FFFFFF;}
</style>
<body>";
echo "<center><h2><strong>REVIEW ANSWERS</strong></h2></center>";
echo "<font size ='5'>";
...
$sql = "SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer FROM ic_engines where QuestionId IN  
(" . implode(",", $samp) . ")";
...
echo "<center>Congratulations!!You passed the test with a  total score of $score out of $y !</center>";}
	...
	echo"<center>Your total score : $score out of $y</br>";
        echo"Please try again to pass the test";
}
echo "</font>";
echo "</body>
</html>";
