<?php
session_start();
if(isset( $_SESSION['completednfpa'])){
	unset($_SESSION['completednfpa']);
    header("Location: https://www.updatraining.com/nfpa/");
	 exit();
 }else{
?>
 <html>
...
<div class="container">
<h1><center>NFPA Practice</h1>
</br></br>
 <?php
echo "<form action='https://www.updatraining.com/wp-admin/nfpa-mock-result.php' method='post'>";
$link = mysqli_connect("localhost", "nirupan_admin", "niru@2089", "nirupan_updamech");
if ($link === false) {
    die("ERROR: Could not connect. " . mysqli_connect_error());
}

$sql       = "(SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer FROM nfpa where
QuestionId BETWEEN 5001 and 5025)";
