...
$sql = "SELECT QuestionId,Question,Option1,Option2,Option3,Option4,Answer,Solution FROM fluid_problems 
...
while ($eval_row = mysqli_fetch_assoc($question)) {
        ...
        if (isset($_POST['a' . $y])) {
            ...
            if ($answered == $Answer){
				...
				echo '<img src="data:image/jpg;base64,'.base64_encode($eval_row['Solution'] ).'"/><br />';
            } 
           ...
           echo '<img src="data:image/jpg;base64,'.base64_encode($eval_row['Question'] ).'"/><br />';
            ...
            echo "</br></br>";
			echo "<strong>See how it is solved:</strong>";
			echo"</br>";
				echo '<img src="data:image/jpg;base64,'.base64_encode($eval_row['Solution'] ).'"/><br />';
